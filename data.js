'use strict';
/* AI HEALTH v31 — DATA + MIGRATION */

var STORAGE_KEY = 'ai_health_v31';
var OLD_KEYS = ['ai_health_v30','ai_health_v29','ai_health_v28','ai_health_v26'];
...
{id:'pumpkin',emoji:'🎃',name:'Тыква',color:'#0d0500',effects:'heavyfog',bg:'#0d0500',halloween:true},
{id:'vampire',emoji:'🦇',name:'Вампир',color:'#0a0000',effects:'vampire',bg:'#0a0000',halloween:true},
{id:'ghost',emoji:'👻',name:'Призрак',color:'#0a0814',effects:'ghost',bg:'#0a0814',halloween:true},
{id:'web',emoji:'🕸',name:'Паутина',color:'#001410',effects:'web',bg:'#001410',halloween:true},
...
try{
  ...
  if(raw){
    ...
    if(!state.detoxChecklists)state.detoxChecklists={};
  } else {
    state=defaultState();
  }
}catch(e){
...
{title:'Present Simple',content:'I work. He works.',practice:'10 предложений о дне.'},
...
{id:'detox_30',icon:'🌱',name:'Курс 30 дней',check:function(s){return (s.detoxCourseProgress&&Object.keys(s.detoxCourseProgress).length>=30)}}
];

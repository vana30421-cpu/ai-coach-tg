'use strict';
var STORAGE_KEY='ai_health_v29';
var THEMES=[
{id:'dark',emoji:'🌙',name:'Тёмная',color:'#000',effects:'stars',bg:'#000'},
{id:'light',emoji:'☀️',name:'Светлая',color:'#f5f5fa',effects:'none',bg:'#f5f5fa'},
...
matrix:[],paths:[],courses:[],levelProgress:{},englishProgress:{},
scheduleBlocks:[],domainScores:{},domainHistory:{},metrics:{},
customHabits:[],habitLog:{},
customGoals:[],goalProgress:{},
customNotes:[],journalEntries:[],
customWater:[],customMood:[],customMeditation:[],customWorkouts:[],
integrations:{
...
settings:{theme:'dark',provider:'gemini',apiKey:'',activePersona:'coach',waterGoal:8,onboardingDone:false,autoMatrix:true,notifications:true,effectsEnabled:true,effectsIntensity:1,reminderTime:'morning',dailyPlanEnabled:true},
...
{id:'memory',title:'Память',emoji:'🧠',category:'Обучение',description:'10 шагов',steps:[{title:'Эббингауз',desc:'Кривая забывания.',secret:'Повторяй через 1ч, 1д, 3д.'},{title:'Локусы',desc:'Дворец памяти.',secret:'Древнегреческий метод.'},{title:'Мнемоники',desc:'Ассоциации.',secret:'Чем страннее, тем лучше.'},{title:'Anki',desc:'Интервальное повторение.',secret:'20 мин/день.'},{title:'Чанкинг',desc:'Группировка.',secret:'7±2 элемента.'},{title:'Recall',desc:'Активное припоминание.',secret:'Testing effect.'},{title:'Фейнман',desc:'Объясни 12-летнему.',secret:'Если не можешь — не понял.'},{title:'Сон',desc:'Консолидация.',secret:'7-9 часов.'},{title:'Двойное кодирование',desc:'Слова + образы.',secret:'Paivio.'},{title:'Система',desc:'Комбинация.',secret:'×3-5 за месяц.'}]}
];
var COURSES_LIBRARY=[
...
{id:'movies',emoji:'🎬',name:'Фильмы',desc:'20 лучших фильмов',tips:'Не более 2 часов. Без телефона.',count:20},
{id:'series',emoji:'📺',name:'Сериалы',desc:'20 культовых сериалов',tips:'1-2 серии в день.',count:20},
{id:'books',emoji:'📚',name:'Книги',desc:'20 книг, меняющих мышление',tips:'20 минут в день. Бумага.',count:20},
{id:'music',emoji:'🎵',name:'Музыка',desc:'10 плейлистов по настроению',tips:'Расслабление. Фокус.',count:10},
{id:'games',emoji:'🎮',name:'Игры',desc:'12 игр с глубоким сюжетом',tips:'Не более 1 часа.',count:12},
{id:'podcasts',emoji:'🎧',name:'Подкасты',desc:'10 подкастов',tips:'В дороге. На прогулке.',count:10},
{id:'theater',emoji:'🎭',name:'Театр',desc:'8 пьес мирового уровня',tips:'Раз в месяц.',count:8},
{id:'art',emoji:'🎨',name:'Искусство',desc:'10 шедевров живописи',tips:'Раз в месяц.',count:10}
];
...
{id:'g_muscle',title:'Нарастить мышечную массу',icon:'💪',category:'Здоровье',metric:'кг'},
{id:'g_run',title:'Пробежать 10 км',icon:'🏃',category:'Здоровье',metric:'км'},
{id:'g_english',title:'Выучить английский до B2',icon:'🇬🇧',category:'Обучение',metric:'уровень'},
{id:'g_book',title:'Прочитать 12 книг за год',icon:'📚',category:'Развитие',metric:'книг'},
{id:'g_save',title:'Накопить 100 000 руб',icon:'💰',category:'Финансы',metric:'руб'},
{id:'g_career',title:'Получить повышение',icon:'📈',category:'Карьера',metric:'этап'},
{id:'g_meditate',title:'Медитировать 100 дней',icon:'🧘',category:'Психика',metric:'дней'},
{id:'g_detox',title:'Уменьшить экран до 2 ч/день',icon:'📱',category:'Цифровое',metric:'ч'},
{id:'g_journal',title:'Написать 100 записей в дневник',icon:'📓',category:'Психика',metric:'записей'}
];
var ACHIEVEMENTS=[

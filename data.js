...
{id:'mental',emoji:'🧠',name:'Ментальное',color:'#4dd4ff',desc:'Фокус, память, ясность',metrics:[{id:'focusMin',label:'Deep Work (мин)',target:'180'},{id:'meditation',label:'Медитаций/нед',target:'7'},{id:'reading',label:'Страниц/день',target:'20'},{id:'learning',label:'Уроков/нед',target:'5'},{id:'memory',label:'Память 1-10',target:'7+'}]},
...
function defaultState(){return{tasks:[],schedule:[],habits:[],goals:[],notes:[],timer:[],chats:[],mood:[],water:[],meds:[],workouts:[],meditations:[],journal:[],media:[],entertainment:[],finance:[],matrix:[],paths:[],courses:[],levelProgress:{},englishProgress:{},scheduleBlocks:[],domainScores:{},domainHistory:{},metrics:{},integrations:{googleCalendar:{connected:false,clientId:'',calendarId:'primary',accessToken:null,lastSync:null},obsidian:{path:'',apiKey:'',autoSync:false,lastSync:null},gemini:{apiKey:'',model:'gemini-1.5-flash',connected:false}},screenTime:{limits:{daily:240,social:60,games:30,work:180},usage:{},detoxMode:false,detoxUntil:null,focusSessions:0},profile:{name:'',emoji:'😊',createdAt:new Date().toISOString(),achievements:[],surveyAnswers:null,surveyStep:0,surveyDone:false,personalPlan:null},settings:{theme:'dark',provider:'gemini',apiKey:'',activePersona:'coach',waterGoal:8,onboardingDone:false,autoMatrix:true,notifications:true,effectsEnabled:true,reminderTime:'morning'},flags:{dnd:false,focus:false},stats:{streak:0,lastActiveDay:null,totalDays:0}}}
var PATHS_LIBRARY=[
...
{id:'movies',emoji:'🎬',name:'Фильмы',desc:'Осознанный просмотр',tips:'Не более 2 часов. Без телефона. Записывай мысли.'},
{id:'series',emoji:'📺',name:'Сериалы',desc:'По сезонам',tips:'1-2 серии в день. Не запоем.'},
{id:'books',emoji:'📚',name:'Книги',desc:'Художественная литература',tips:'20 минут в день. Бумага. Без телефона.'},
{id:'music',emoji:'🎵',name:'Музыка',desc:'Плейлисты настроения',tips:'Расслабление. Фокус. Настроение.'},
{id:'games',emoji:'🎮',name:'Игры',desc:'Время и жанры',tips:'Не более 1 часа. Осознанно.'},
{id:'podcasts',emoji:'🎧',name:'Подкасты',desc:'Обучение + развлечение',tips:'В дороге. На прогулке.'},
{id:'theater',emoji:'🎭',name:'Театр',desc:'Живое искусство',tips:'Раз в месяц. С близкими.'},
{id:'art',emoji:'🎨',name:'Искусство',desc:'Музеи, галереи',tips:'Раз в месяц. Вдохновение.'}
];
var ACHIEVEMENTS=[

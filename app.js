...
function startEyeExercise(id){
  var ex=(window.VISION_EXERCISES||[]).find(function(x){return x.id===id});
  if(!ex)return;
  currentVisionExercise=ex;
  var html='<div style="text-align:center;margin-bottom:16px;"><div style="font-size:56px;">'+ex.emoji+'</div><div style="font-size:22px;font-weight:800;">'+ex.title+'</div><div class="footnote text-secondary">'+ex.duration+' · '+ex.benefit+'</div></div>';
  html+='<div class="card"><div class="lesson-section"><div class="lesson-section-title">📋 Что делать</div><div class="lesson-content">'+esc(ex.desc)+'</div></div></div>';
  html+='<div class="card"><div class="lesson-section practice"><div class="lesson-section-title">🎯 Как</div><div class="lesson-content">'+esc(ex.how)+'</div></div></div>';

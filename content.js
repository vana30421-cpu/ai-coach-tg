...
/* ============================================================
   ...
   Темы, домены, мудрости, челленджи, обучение, гормоны, психология
   ============================================================ */
...
{id:'ember',emoji:'🔥',name:'Угли',bg:'#140800',bg2:'#251205',text:'#ffe0c0',brand:'#ff6600',brand2:'#cc3300',effect:'fire'},
...
/* ============ ГОРМОНЫ (20) ============ */
var HORMONES=[
{id:'dopamine',emoji:'⚡',name:'Дофамин',role:'Мотивация, предвкушение',what:'Нейромедиатор предвкушения награды, мотивации, обучения. НЕ гормон удовольствия — гормон желания.',where:'VTA → прилежащее ядро → префронтальная кора.',when:'Растёт при предвкушении награды (не при получении), новизне, движении к цели.',up:['Достижение целей','Спорт','Музыка','Тёмный шоколад','Утренний свет','Холодный душ','Медитация','Новизна','Обучение','Социальное признание'],down:['Соцсети','Сахар','Игры','Порнография','Шопинг','Уведомления','Многозадачность','Стресс','Недосып','Кофеин вечером','Алкоголь'],food:'Тирозин: мясо, рыба, яйца, орехи, сыр.',sleep:'7-9 часов. Недосып = -30% рецепторов.',sport:'Умеренный кардио 3-4×/нед + силовые 2×/нед.',normal:'Стабильная мотивация, интерес к новому.',imbalance:'Прокрастинация, апатия, ангедония, зависимости.',protocol:['Дофамин-детокс 1×/нед','Утро без телефона 30-60 мин','Награда ПОСЛЕ усилия','Убери уведомления','Замени соцсети на общение','Холодный душ утром','Утренний свет 20 мин'],example:'Ты думаешь о пицце → дофамин растёт → ешь → падает. Предвкушение слаще.',symptoms:['Скука от простого','Зависимость от телефона','Прокрастинация','Апатия']},
{id:'serotonin',emoji:'☀️',name:'Серотонин',role:'Настроение, спокойствие',what:'Нейромедиатор настроения, спокойствия, аппетита, сна. 90% в кишечнике.',where:'Ядра шва в стволе; 90% — в кишечнике.',when:'Растёт при солнечном свете, еде с триптофаном, спорте, медитации.',up:['Солнце 10-20 мин','Спорт','Медитация','Триптофан','Массаж','Прогулки','Улыбка','Объятия','Смех','Свежий воздух'],down:['Изоляция','Тёмная комната','Стресс','Алкоголь','Кофеин вечером','Недосып','Сидячий образ'],food:'Триптофан: индейка, курица, сыр, бананы, овсянка.',sleep:'Регулярный режим. 7-9 ч.',sport:'Аэробные 30 мин 4-5×/нед.',normal:'Спокойствие, стабильное настроение.',imbalance:'Депрессия, тревога, бессонница, ПМС.',protocol:['Утренний свет 20 мин','Прогулка 30 мин','Медитация','Триптофан в каждый приём','Массаж 1×/нед','Объятия 8×/день','Убрать алкоголь'],example:'Зимой серотонин падает → сезонная депрессия. Световая лампа 10 000 люкс = эффект антидепрессанта.',symptoms:['Подавленность','Тревога','Бессонница','Тяга к сладкому']},
{id:'oxytocin',emoji:'💞',name:'Окситоцин',role:'Привязанность, доверие',what:'Нейропептид привязанности, доверия, любви, эмпатии. «Гормон объятий».',where:'Гипоталамус → задняя доля гипофиза.',when:'Растёт при объятиях 20+ сек, времени с близкими, массаже.',up:['Объятия 20 сек','Время с близкими','Массаж','Секс','Питомцы','Помощь другим','Медитация метта','Совместный сон'],down:['Одиночество','Стресс','Цифровое общение','Изоляция','Недоверие','Травмы'],food:'Магний: орехи, семечки. Омега-3: рыба.',sleep:'Объятия перед сном.',sport:'Йога, танцы, парные виды.',normal:'Близость, доверие, эмпатия.',imbalance:'Одиночество, депрессия, недоверие.',protocol:['8 объятий по 20 сек','Звонок близкому','Питомец/волонтёрство','Массаж 1×/нед','Медитация метта','Совместные ужины без телефонов'],example:'20-секундное объятие → окситоцин → снижает кортизол. Меньше 20 сек — не работает.',symptoms:['Одиночество','Тревога в отношениях','Недоверие']},
{id:'endorphins',emoji:'🏃',name:'Эндорфины',role:'Обезболивание, эйфория',what:'Эндогенные опиоиды — обезболивающие и дающие эйфорию.',where:'Гипофиз, гипоталамус, надпочечники, ЦНС.',when:'Растёт при спорте 30+ мин, смехе, сексе, тёмном шоколаде, острой еде.',up:['Спорт 30+ мин','Смех','Секс','Тёмный шоколад','Острая еда','Музыка','Массаж','Танцы','Пение'],down:['Сидячий образ','Хроническая боль','Стресс','Отсутствие смеха','Депрессия'],food:'Острая еда, шоколад 70%+, клубника.',sleep:'Спорт за 3 ч до сна.',sport:'Кардио 30-60 мин 4-5×/нед.',normal:'Лёгкость, радость, устойчивость к боли.',imbalance:'Хроническая боль, депрессия.',protocol:['30 мин кардио 4×/нед','Смех ежедневно','Массаж 1×/нед','Тёмный шоколад 20 г','Танцы 2×/нед'],example:'«Эйфория бегуна» — после 40+ мин бега эндорфины дают подъём.',symptoms:['Хроническая боль','Плохое настроение']},
{id:'cortisol',emoji:'🔥',name:'Кортизол',role:'Стресс, мобилизация',what:'Главный гормон стресса. Мобилизует глюкозу, повышает давление.',where:'Кора надпочечников. HPA-ось.',when:'Растёт при стрессе, опасности, голоде, утром (пик 6-8).',up:['Хронический стресс','Мало сна','Кофе на голодный','Переработка','Ссоры','Новости','Соцсети'],down:['Медитация','Спорт','Сон 7-9 ч','Природа','Дыхание 4-7-8','Объятия','Смех','Прогулки'],food:'Магний, омега-3, витамин C, L-теанин.',sleep:'7-9 часов. До 23:00.',sport:'Умеренно.',normal:'Утро пик, вечер спад.',imbalance:'Тревога, бессонница, набор веса, гипертония, диабет 2 типа.',protocol:['Утренний свет 20 мин','Убрать кофе после 14:00','Медитация 10 мин','Прогулка 30 мин','Дыхание 4-7-8','Магний вечером','Объятия 20 сек'],example:'Пик кортизола утром помогает проснуться. Хронический стресс = изнашивание.',symptoms:['Тревога','Бессонница','Набор веса','Частые простуды']},
{id:'testosterone',emoji:'💪',name:'Тестостерон',role:'Сила, либидо, уверенность',what:'Главный мужской половой гормон. Мышцы, либидо, уверенность.',where:'Яички (клетки Лейдига).',when:'Пик утром (6-9 ч).',up:['Силовые 3×/нед','Белок 1.6-2 г/кг','Цинк','Сон 7-9 ч','Солнце','Холодный душ','Победы','Соревнования','Витамин D'],down:['Мало сна','Алкоголь','Стресс','Сахар','Перетренированность','Соя','Ожирение','Дефицит цинка'],food:'Цинк: мясо, устрицы, яйца. Витамин D: рыба, яйца, солнце.',sleep:'7-9 ч. Пик во сне.',sport:'Силовые 3×/нед (присед, становая, жим). HIIT 1-2×/нед.',normal:'Энергия, либидо, мышцы.',imbalance:'Усталость, снижение либидо, депрессия.',protocol:['Силовые 3×/нед','Сон 8 ч','Цинк + магний + витамин D','Холодный душ','Убрать алкоголь','Снизить сахар','Соревнования','Солнце 20 мин'],example:'После силовой тестостерон растёт на 15-20% на 2-3 часа.',symptoms:['Усталость','Снижение либидо','Потеря мышц','Набор жира']},
{id:'estrogen',emoji:'🌸',name:'Эстроген',role:'Женское здоровье',what:'Группа женских половых гормонов. Цикл, кости, кожа, настроение.',where:'Яичники, кора надпочечников, жировая ткань.',when:'Колеблется по циклу. Пик перед овуляцией.',up:['Здоровый вес','Флавоноиды','Фитоэстрогены','Сон','Умеренный спорт'],down:['Избыток веса','Стресс','Алкоголь','Сахар','Менопауза','Перетренированность','Мало жиров'],food:'Соя, лён, кунжут, ягоды, брокколи.',sleep:'7-9 ч.',sport:'Умеренные, йога, пилатес.',normal:'Стабильный цикл, здоровая кожа, крепкие кости.',imbalance:'ПМС, проблемы с кожей, остеопороз.',protocol:['Сбалансированное питание','Сон 8 ч','Проверка гормонов 1×/год','Магний + B6','Убрать алкоголь'],example:'ПМС = падение эстрогена. Магний + B6 + меньше сахара снижают симптомы.',symptoms:['ПМС','Проблемы с кожей','Приливы','Сухость']},
{id:'progesterone',emoji:'🌺',name:'Прогестерон',role:'Цикл, спокойствие',what:'Женский гормон, готовящий матку. Успокаивающее действие на мозг.',where:'Жёлтое тело, плацента.',when:'Растёт после овуляции.',up:['Сон 8 ч','Витамин B6','Магний','Цинк'],down:['Стресс','Мало сна','Алкоголь','Дефицит B6'],food:'B6: бананы, курица, рыба.',sleep:'7-9 ч.',sport:'Умеренные, йога.',normal:'Стабильный цикл, спокойствие.',imbalance:'ПМС, бессонница, тревожность.',protocol:['Сон 8 ч','B6 + магний','Умеренный спорт','Убрать алкоголь'],example:'Низкий прогестерон = тревожность и бессонница перед месячными.',symptoms:['ПМС','Бессонница','Тревожность']},
{id:'insulin',emoji:'🍬',name:'Инсулин',role:'Регуляция сахара',what:'Гормон поджелудочной, регулирующий глюкозу.',where:'Бета-клетки островков Лангерганса.',when:'Растёт при приёме углеводов.',up:['Быстрые углеводы','Перекусы','Сидячий образ','Стресс','Мало сна'],down:['Интервальное голодание','Спорт','Белок','Овощи','Клетчатка','Жиры','Уксус'],food:'Овощи, белок, жиры, клетчатка.',sleep:'7-9 ч. Недосып = инсулинорезистентность.',sport:'Силовые + кардио. Движение после еды.',normal:'Стабильный сахар, энергия.',imbalance:'Диабет 2 типа, ожирение, усталость.',protocol:['Меньше сахара','Больше овощей','Движение после еды','16:8','Уксус перед едой','Белок в каждый приём','Силовые 3×/нед'],example:'10 мин прогулка после еды снижает пик глюкозы на 30%.',symptoms:['Тяга к сладкому','Усталость после еды','Набор веса']},
{id:'leptin',emoji:'🍔',name:'Лептин',role:'Сытость',what:'Гормон сытости, сообщающий мозгу о запасах энергии.',where:'Жировая ткань.',when:'Растёт после еды.',up:['Сон 7-9 ч','Белок','Овощи','Клетчатка','Здоровые жиры'],down:['Недосып','Сахар','Переедание','Стресс'],food:'Белок, клетчатка, овощи.',sleep:'Критично 7-9 ч.',sport:'Умеренные.',normal:'Сытость после еды.',imbalance:'Лептинорезистентность → постоянный голод.',protocol:['Сон 8 ч','Белок 1.6 г/кг','Убрать сахар','Овощи 500 г','Меньше перекусов'],example:'Недосып 4 ч → лептин -18%, грелин +28% → +300 калорий.',symptoms:['Постоянный голод','Набор веса']},
{id:'ghrelin',emoji:'🍽',name:'Грелин',role:'Голод',what:'Гормон голода, стимулирующий аппетит.',where:'Желудок (P/D1 клетки).',when:'Растёт на голодный желудок.',up:['Недосып','Стресс','Быстрые углеводы'],down:['Белок','Клетчатка','Вода','Сон'],food:'Белок, клетчатка, вода.',sleep:'7-9 ч.',sport:'Умеренно.',normal:'Голод по расписанию.',imbalance:'Постоянный голод, переедание.',protocol:['Сон 8 ч','Вода перед едой','Белок на завтрак','Регулярное питание'],example:'Белок на завтрак (30 г) снижает грелин на 6 часов.',symptoms:['Постоянный голод','Переедание']},
{id:'melatonin',emoji:'🌙',name:'Мелатонин',role:'Сон, восстановление',what:'Гормон сна, регулирующий циркадные ритмы.',where:'Эпифиз мозга.',when:'Растёт вечером (после 21:00), пик 2-4 ч ночи.',up:['Темнота','Режим','Тёплый свет','Медитация','Вишня','Овсянка'],down:['Синий свет','Экраны','Кофеин','Алкоголь','Яркий свет вечером'],food:'Вишня, овсянка, бананы, рис.',sleep:'Одно время. Тёмная спальня. 18-20°C.',sport:'Утром/днём.',normal:'Засыпание 15-20 мин.',imbalance:'Бессонница, поверхностный сон.',protocol:['Тёмная спальня','Экран за 2 ч до сна','Тёплый свет 19:00+','Утренний свет 20 мин','Одно время сна','Магний'],example:'2 часа без экрана перед сном = мелатонин +50%.',symptoms:['Бессонница','Поверхностный сон','Утренняя разбитость']},
...
/* ============ КОНЕЦ ЧАСТИ 1/2 ============ */
console.log('[CONTENT 1/2] Темы='+THEMES.length+' Гормоны='+HORMONES.length+' Уровни='+LEARNING_LEVELS.length+' Достижения='+ACHIEVEMENTS.length);
/* ============================================================
   LIFE OS — CONTENT.js v41 — ЧАСТЬ 2/2
   Психология, мышление, этикет, богатство, навыки, методики,
   восстановление, зрение, детокс, English, финальный экспорт
   ============================================================ */
...
{id:'ps_10',cat:'Мышление',emoji:'💡',title:'Ментальные модели',theory:'80+ моделей: инверсия, второй порядок, first principles.',science:'Маск, Баффет используют.',practice:['1 модель/нед'],effect:'+Решения',tips:'Инструменты',test:[{q:'Сколько моделей?',options:['5-10','80+','200+'],correct:1}]},
...
{id:'ps_19',cat:'Мышление',emoji:'💭',title:'КПТ',theory:'Мысль → Эмоция → Поведение.',science:'Золотой стандарт психотерапии.',practice:['Дневник мыслей'],effect:'-Тревога',tips:'Мысли ≠ факты',test:[{q:'Что первое в КПТ?',options:['Эмоция','Мысль','Поведение'],correct:1}]},
...
{id:'et_116',cat:'Жесты',emoji:'🤏',title:'Жесты руками',theory:'Умеренные.',science:'Классика.',practice:['Умеренные'],effect:'+Впечатление',tips:'Умеренные'},
{id:'et_117',cat:'Жесты',emoji:'🦶',title:'Ноги',theory:'Не тряси.',science:'Классика.',practice:['Спокойно'],effect:'+Уверенность',tips:'Спокойно'},
...
{id:'et_119',cat:'Жесты',emoji:'📏',title:'Дистанция',theory:'Личная 45-120 см.',science:'Проксемика.',practice:['45-120'],effect:'+Комфорт',tips:'45-120'},
{id:'et_120',cat:'Жесты',emoji:'👃',title:'Жесты лица',theory:'Не трогай лицо.',science:'Классика.',practice:['Не трогай'],effect:'+Впечатление',tips:'Не трогай'},
{id:'et_121',cat:'Подарки',emoji:'🎁',title:'Выбор подарка',theory:'Знай интересы.',science:'Классика.',practice:['Интересы','Не деньги'],effect:'+Впечатление',tips:'Интересы'},
...
{id:'et_125',cat:'Подарки',emoji:'💰',title:'Деньги',theory:'Только близким.',science:'Классика.',practice:['Близким','Красиво'],effect:'+Впечатление',tips:'Близким'},
...
{id:'et_130',cat:'Подарки',emoji:'💎',title:'Драгоценности',theory:'Только близким.',science:'Классика.',practice:['Близким','Вкус'],effect:'+Впечатление',tips:'Вкус'},
{id:'et_131',cat:'Работа',emoji:'👔',title:'Дресс-код',theory:'Узнай заранее.',science:'Деловой.',practice:['Узнай','Следуй'],effect:'+Впечатление',tips:'Узнай'},
{id:'et_132',cat:'Работа',emoji:'⏰',title:'Пунктуальность',theory:'Приходи за 5 мин.',science:'Деловой.',practice:['5 мин'],effect:'+Уважение',tips:'5 мин'},
{id:'et_133',cat:'Работа',emoji:'💼',title:'Внешний вид',theory:'Аккуратный.',science:'Деловой.',practice:['Аккуратный'],effect:'+Впечатление',tips:'Аккуратный'},
...
{id:'et_142',cat:'Финансы',emoji:'🏦',title:'Банк',theory:'Знай условия.',science:'Финансы.',practice:['Условия'],effect:'+Защита',tips:'Условия'},
{id:'et_143',cat:'Финансы',emoji:'💳',title:'Кредит',theory:'Только по необходимости.',science:'Финансы.',practice:['По необходимости','Вовремя'],effect:'+Кредит',tips:'Вовремя'},
...
{id:'et_182',cat:'Соседи',emoji:'🔇',title:'Шум',theory:'Тишина после 23:00.',science:'Соседи.',practice:['Тишина','Не сверли'],effect:'+Мир',tips:'Тишина'},
...
{id:'et_189',cat:'Соседи',emoji:'🎁',title:'Подарки',theory:'По праздникам.',science:'Соседи.',practice:['По праздникам'],effect:'+Связь',tips:'По праздникам'},
...
{id:'et_198',cat:'За рубежом',emoji:'🍺',title:'Алкоголь',theory:'Знай меру.',science:'Путешествия.',practice:['Мера'],effect:'+Впечатление',tips:'Мера'},
...
{id:'et_234',cat:'Прочее',emoji:'🚶',title:'Походка',theory:'Уверенная.',science:'Этикет.',practice:['Уверенная'],effect:'+Впечатление',tips:'Уверенная'},
...
{id:'r_sleep',cat:'💪 Физическое',emoji:'😴',title:'Полноценный сон',desc:'7-9 часов качественного сна.',how:'Режим, темнота, 18-20°C, без экрана за 2 ч.',time:'7-9 ч',effect:'Восстановление всех систем',science:'90-мин циклы, консолидация памяти.',times:'Каждую ночь'},
...
{id:'r_sauna',cat:'💪 Физическое',emoji:'🔥',title:'Сауна 20 мин',desc:'Финская.',how:'80-100°C.',time:'20 мин',effect:'+Кровоток',science:'Кардио-эффект.',times:'2-4×/нед'},
...
{day:3,phase:'🚀 Подготовка',title:'Утро без телефона',subtitle:'Первые 30 минут',emoji:'🌅',theory:'**Первые 30 минут** определяют день.',science:'**UBC:** +21% продуктивности, -15% тревожности.',do:['Телефон в комнате','30 мин без','500 мл воды','10 мин света','Душ','Зарядка'],effect:'+Продуктивность',tips:'Купи будильник'},
{day:4,phase:'📅 Неделя 1',title:'Замечай импульсы',subtitle:'Счёт',emoji:'🎯',theory:'**Импульс** — внезапное желание проверить.',science:'**96 раз в день** — рефлекс.',do:['Каждый раз — заметь','Скажи "импульс"','Запиши триггер','Счётчик','Итог в конце'],effect:'+Контроль',tips:'Не суди'},
{day:5,phase:'📅 Неделя 1',title:'Еда без экрана',subtitle:'Осознанное питание',emoji:'🍽',theory:'**Еда + экран =** не чувствуешь вкус.',science:'**Liverpool:** +25% калорий с телефоном.',do:['Все приёмы без телефона','Телефон в комнате','20+ мин','Вкус','Насыщение'],effect:'-20-30% калорий',tips:'Начни с обеда'},
...
{day:9,phase:'📅 Неделя 2',title:'Соцсети 30 минут',subtitle:'Лимит',emoji:'📱',theory:'**Не запрет, а ограничение.** 30 минут — достаточно.',science:'**2.5 ч/день** без лимита.',do:['Лимит 30 мин','До 18:00','Блокировка','Не в кровати','В перерывах'],effect:'-2 ч/день',tips:'Начни с 60'},
{day:10,phase:'📅 Неделя 2',title:'Чёрно-белый экран',subtitle:'Скучный телефон',emoji:'⚫',theory:'**Цвет — магнит.**',science:'**Konstanz:** -50% соцсетей, -37% экрана.',do:['iPhone: Спец.возможности','Android: Цифровое','Держи 24 ч'],effect:'-50%',tips:'Оставь навсегда'},
...
{day:12,phase:'📅 Неделя 2',title:'Глубокий час',subtitle:'90 минут Deep Work',emoji:'🎯',theory:'**90 минут** — суперсила. ×3 продуктивности.',science:'**Newport:** ×3 объём, ×4 меньше багов.',do:['Одна задача','Авиарежим 90','Телефон вне','Таймер','Перерыв 15'],effect:'×3',tips:'Утро — лучшее'},
...
{day:16,phase:'📅 Неделя 3',title:'Хобби 30 минут',subtitle:'Руками',emoji:'🎨',theory:'**Руками — лекарство.**',science:'**Otago:** +30% удовлетворения.',do:['Хобби','30 мин','Без телефона','Одно время','Показывай'],effect:'+30%',tips:'Не дорогое'},
...
{day:26,phase:'📅 Неделя 4',title:'Дофаминовое голодание',subtitle:'4 часа',emoji:'🧘',theory:'**Отдых дофаминовой системы.**',science:'**+Чувствительность к дофамину.**',do:['4 ч без стимулов','Телефон в комнате','Прогулка/медитация','Скучай','Записывай'],effect:'+Радость',tips:'Раз в неделю'},
...
{day:29,phase:'📅 Неделя 4',title:'План на будущее',subtitle:'Как сохранить',emoji:'📋',theory:'**Привычки остаются.**',science:'**80% сохраняют с планом.**',do:['3 правила','3 лимита','3 ритуала','3 сигнала срыва','План восстановления'],effect:'80%',tips:'Конкретно'},
